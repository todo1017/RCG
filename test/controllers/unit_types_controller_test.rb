...
class UnitTypesControllerTest < ActionController::TestCase
  ...
  test "should create unit_type" do
    assert_difference('UnitType.count') do
      post :create, unit_type: { baths: @unit_type.baths, beds: @unit_type.beds, description: @unit_type.description, floor_high: @unit_type.floor_high, floor_low: @unit_type.floor_low, sq_ft_high: @unit_type.sq_ft_high, sq_ft_low: @unit_type.sq_ft_low }
    end
  ...
  test "should update unit_type" do
    patch :update, id: @unit_type, unit_type: { baths: @unit_type.baths, beds: @unit_type.beds, description: @unit_type.description, floor_high: @unit_type.floor_high, floor_low: @unit_type.floor_low, sq_ft_high: @unit_type.sq_ft_high, sq_ft_low: @unit_type.sq_ft_low }
    assert_redirected_to unit_type_path(assigns(:unit_type))
  end
